...
public function savedPosts()
{
    return $this->hasManyThrough(
        Post::class,    // النموذج النهائي الذي نريد الوصول له
        Save::class,    // الجدول الوسيط
        'user_id',      // المفتاح في جدول Save الذي يربطه بـ User
        'id',           // المفتاح في جدول Post الذي يربطه بـ Save
        'id',           // المفتاح في User الذي يربطه بـ Save
        'post_id'       // المفتاح في Save الذي يربطه بـ Post
    );
}
